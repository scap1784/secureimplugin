...
// Last change on : $Date: 2006-05-17 01:38:00 +0400 (Ð¡Ñ€, 17 Ð¼Ð°Ð¹ 2006) $
...
unsigned long forkthread(void (__cdecl *threadcode)(void*), unsigned long stacksize, void *arg)
{
  ...
  rc = _beginthread((void (_cdecl*)(void *))&forkthread_r, stacksize, &fa);
 ...
 void *arg, unsigned cf, unsigned *thraddr)
{
  ...
  rc = _beginthreadex(sec,stacksize,(unsigned int(__stdcall*)(void*))&forkthreadex_r,&fa,0,thraddr);
  if (rc) 
  {
    WaitForSingleObject(fa.hEvent,INFINITE);
  } 
